...
#       boy.y = clamp(boy.canvas_height // 2, boy.y, boy.bg.h - boy.canvas_height // 2)
    ...
    def draw(boy):
        ...
        boy.font.draw(cx , cy + 50, '%d' % (boy.cnt_collide_ball), (255, 255, 0))
...
class Boy:
   ...
   #     self.font.draw(self.canvas_width//2 , self.canvas_height//2 + 50, '%d' % (self.cnt_collide_ball), (255, 255, 0))
